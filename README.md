...
| --------------------------------------------- | ---------------------------------------------- |
| ![Original HTML]([https://github.image1](https://raw.githubusercontent.com/arijarman/insta-message-sorter/main/web/.old.png))       | ![Chat Bubble HTML]|(https://raw.githubusercontent.com/arijarman/insta-message-sorter/main/web/new.png)     |
