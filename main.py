...
def convert_to_ist(alaska_time_str):
    # Use dateutil.parser to flexibly handle different timestamp formats
    alaska_time = parser.parse(alaska_time_str)  # Automatically detects the format
    ...
    for file_path in file_paths:
        with open(file_path, 'r', encoding='utf-8') as file:
            ...
            for div in message_divs:
                ...
                # Convert the time to IST using flexible parsing
